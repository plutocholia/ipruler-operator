...
// +kubebuilder:webhook:path=/validate-ipruler-pegah-tech-v1-clusterconfig,mutating=false,failurePolicy=fail,sideEffects=None,groups=ipruler.pegah.tech,resources=clusterconfigs,verbs=create;update,versions=v1,name=vclusterconfig.kb.io,admissionReviewVersions=v1

var _ webhook.Validator = &ClusterConfig{}

// ValidateCreate implements webhook.Validator so a webhook will be registered for the type
func (r *ClusterConfig) ValidateCreate() (admission.Warnings, error) {
	clusterconfiglog.Info("validate create", "name", r.Name)
...
func (r *ClusterConfig) ValidateDelete() (admission.Warnings, error) {
	clusterconfiglog.Info("validate delete", "name", r.Name)
