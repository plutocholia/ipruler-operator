...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FullConfig) DeepCopyInto(out *FullConfig) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FullConfig.
func (in *FullConfig) DeepCopy() *FullConfig {
	if in == nil {
		return nil
	}
	out := new(FullConfig)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *FullConfig) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FullConfigList) DeepCopyInto(out *FullConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]FullConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FullConfigList.
func (in *FullConfigList) DeepCopy() *FullConfigList {
	if in == nil {
		return nil
	}
	out := new(FullConfigList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *FullConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FullConfigSpec) DeepCopyInto(out *FullConfigSpec) {
	*out = *in
	...
	in.MergedConfig.DeepCopyInto(&out.MergedConfig)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FullConfigSpec.
func (in *FullConfigSpec) DeepCopy() *FullConfigSpec {
	if in == nil {
		return nil
	}
	out := new(FullConfigSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FullConfigStatus) DeepCopyInto(out *FullConfigStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FullConfigStatus.
func (in *FullConfigStatus) DeepCopy() *FullConfigStatus {
	if in == nil {
		return nil
	}
	out := new(FullConfigStatus)
	in.DeepCopyInto(out)
	return out
}
